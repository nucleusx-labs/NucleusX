    ...
    <div className="max-w-6xl mx-auto w-full py-6 sm:py-10 space-y-8">
      <header>
        ...
        <p className="text-ncx-text-muted mt-2 max-w-xl">
          View the pools where you currently hold LP tokens, add more liquidity, or remove your position.
        </p>
      </header>
      ...
      <div className="ncx-card overflow-hidden">
        <div className="p-5 border-b border-ncx-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <h2 className="text-base font-semibold text-ncx-text">Your pools</h2>
          ...
          <table className="w-full text-left min-w-[520px]">
            ...
            <tbody>
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={3} className="px-6 py-12 text-center text-ncx-text-muted text-sm">
                    {pools.length === 0
                      ? 'No LP positions found yet. Add liquidity to get started.'
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="ncx-num text-[10px] uppercase tracking-[0.1em] text-ncx-text-subtle">v2</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <Link
                        ...
                        className="ncx-num text-[10px] uppercase tracking-[0.1em] px-3 py-1.5 rounded-full border transition-all duration-200 inline-block border-ncx-purple-500/40 bg-ncx-purple-500/10 text-ncx-text hover:border-ncx-purple-500 hover:bg-ncx-purple-500/20"
                      >
                        Remove
                      </Link>
                    </div>
